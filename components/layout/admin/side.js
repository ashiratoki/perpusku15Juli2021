...
export default function Side() {
    ...
    <div className="container-fluid d-flex flex-column p-0" >
      ...
      <span style={{marginRight: 0, borderColor: 'rgb(255,255,255)', color: 'rgb(255,255,255)', marginTop: 6, fontSize: 18, fontFamily: 'Alata, sans-serif'}}>SMK DARUL ANWAR</span>
      <ul className="navbar-nav text-light" id="accordionSidebar" style={{marginTop: 19}}>
        ...
        <li className="nav-item dropdown">
          ...
          <Link href="/admin/data-siswa"><a className="dropdown-item" style={{fontSize: 16}}><i className="fa fa-user" />&nbsp; &nbsp;Data Siswa</a></Link>
