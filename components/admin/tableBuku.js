        ...
        <tbody>
          {currentPosts.filter((tblDat) => {
            if (searchTerm == "") {
              ...
              return tblDat
            } else if (tblDat.stok.toLowerCase().includes(searchTerm.toLowerCase())) {
              return tblDat
            } else if (tblDat.tersedia.toLowerCase().includes(searchTerm.toLowerCase())) {
              return tblDat
            ...
            <tr>
              ...
              <td><div className="btn-group-vertical btn-group-sm">
                <Link href={`/admin/update-buku?index_buku=${tblDat.index_buku}&no_klasifikasi=${tblDat.no_klasifikasi}&status=${tblDat.status}&tgl_masuk=${tblDat.tgl_masuk}&id_buku=${tblDat.id_buku}&index_buku_lama=${tblDat.index_buku}&no_klasifikasi_lama=${tblDat.no_klasifikasi}`}>
